...
class ResponseBuilder:
    ...
    def success(response_type: str, data=None):
        ...
        type_mapping = {
            ...
            'email_verification_resent': (StandardResponseMessages.EMAIL_VERIFICATION_RESENT, StandardResponseCodes.EMAIL_VERIFICATION_RESENT),
            ...
            'password_reset_otp_resent': (StandardResponseMessages.PASSWORD_RESET_OTP_RESENT, StandardResponseCodes.PASSWORD_RESET_OTP_RESENT),
    ...
    def error(response_type: str, errors=None):
        ...
        type_mapping = {
            ...
            'email_required': (StandardResponseMessages.EMAIL_REQUIRED, StandardResponseCodes.EMAIL_REQUIRED),
            'request_required': (StandardResponseMessages.REQUEST_REQUIRED, StandardResponseCodes.REQUEST_REQUIRED),
            'email_already_verified': (StandardResponseMessages.EMAIL_ALREADY_VERIFIED, StandardResponseCodes.EMAIL_ALREADY_VERIFIED),
            'resend_failed': (StandardResponseMessages.RESEND_FAILED, StandardResponseCodes.RESEND_FAILED),
            'verification_token_expired': (StandardResponseMessages.VERIFICATION_TOKEN_EXPIRED, StandardResponseCodes.VERIFICATION_TOKEN_EXPIRED),
            ...
            'password_reset_otp_resend_failed': (StandardResponseMessages.PASSWORD_RESET_OTP_RESEND_FAILED, StandardResponseCodes.PASSWORD_RESET_OTP_RESEND_FAILED),
